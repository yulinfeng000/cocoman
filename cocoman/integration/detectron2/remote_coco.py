...
"""
    ...
    for imgObj, annIds in imgs_anns:
        record = {}
        ...
        for anno in annObjs:
            ...
            if coco_api.annHas(anno, "segmentation"):
            ...
            if coco_api.annHas(anno, "keypoints"):
...
def register_coco_instances(name, metadata, remote_coco):
    """
    ...
    DatasetCatalog.register(name, lambda: load_remote_coco_json(remote_coco, name))
